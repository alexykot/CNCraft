...
func (d *SPacketDispatcher) HandleNewConnection(lope *envelope.E) {
	...
	handler := func(lope *envelope.E) {
		...
		if err = d.dispatchPacketHandling(pacType, sPacket); err != nil {
...
func (d *SPacketDispatcher) dispatchPacketHandling(pactype protocol.PacketType, packet protocol.SPacket) error {
	// TODO actually handle incoming packets here
	return nil
}
