...
var InventoryWhere = struct {
	...
	PlayerID:   whereHelperstring{field: "\"cncraft\".\"inventory\".\"player_id\""},
...
func FindInventory(ctx context.Context, exec boil.ContextExecutor, playerID string, slotNumber int16, selectCols ...string) (*Inventory, error) {
...
func InventoryExists(ctx context.Context, exec boil.ContextExecutor, playerID string, slotNumber int16) (bool, error) {
	var exists bool
