...
const (
	...
	protocolSQueryEntityNBT             ProtocolPacketID = 0x02
	protocolSSetDifficulty              ProtocolPacketID = 0x03
	protocolSChatMessage                ProtocolPacketID = 0x04
	protocolSClientStatus               ProtocolPacketID = 0x05
	protocolSClientSettings             ProtocolPacketID = 0x06
	protocolSTabComplete                ProtocolPacketID = 0x07
	protocolSWindowConfirmation         ProtocolPacketID = 0x08
	protocolSClickWindowButton          ProtocolPacketID = 0x09
	protocolSClickWindow                ProtocolPacketID = 0x0A
	protocolSCloseWindow                ProtocolPacketID = 0x0B
	protocolSPluginMessage              ProtocolPacketID = 0x0C
	protocolSEditBook                   ProtocolPacketID = 0x0D
